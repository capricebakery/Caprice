const Postres = () => {
    ...
    const cupcakes = [
        ...
        {src:"/img/cupcakes2.png", titulo:"Cupcakes", item1:"Limon", item2:"Mandarina", item3:"Mora"},  
    ...
    const browniesMerengues = [
        ...
        {src:"/img/merengue.png", titulo:"Merengues", item1:"Italiano",item2:"Frances", item3:"Suizo"} 
    ]
    return (
        <div>
            <section className="flex w-auto md:flex-row flex-col items-center h-150 bg-linear-to-t from-[#F4E1C1] to-[#f7f2dc]
                ...
                <div>
                    <h1 className="font-titulos text-[100px] mb-10">Postres</h1>
                    <p className="font-titulos text-[30px]">Endulza tu día desde el primer bocado con nuestros irresistibles postres caseros.</p>
                </div>
                <img className="w-[700px] mb-10" src="/img/pagepostres.png"/>
            </section>
                ...
                <div>
                    <div>{/* Seccion Galletas*/}
                        <div className="flex items-center gap-5 mb-20">
                            <h2 className="font-titulos text-[50px] px-5" >Galletas</h2>
                    ...
                    <div> {/* Seccion Cupcakes*/}
                        <div className="flex items-center gap-5 mb-20">
                            <h2 className="font-titulos text-[50px] px-5">Cupcakes</h2>
                            <div className="w-full h-[2px] bg-gray-500 my-4"></div>
                        </div>
