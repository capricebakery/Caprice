    ...
    return(
        <div>
            <section className=" relative w-auto flex md:flex-row flex-col items-center h-150 bg-linear-to-t from-[#F4E1C1] to-[#f7f2dc]
                ...
                <div className=" px-10">
                    <h1 className="font-titulos text-[100px] max-w-md">Panaderia</h1>
                    <p className="font-titulos text-[30px] mt-4 max-w-md">Déjate consentir desde la mañana con el toque artesanal de nuestros panes frescos.</p>
                </div>
                <img className="absolute top-0 right-0 transform -translate-x-1 -translate-y-25 w-[700px] h-[770px]" src="/img/pagepanaderia.png" alt="panes"/>
            </section>
                ...
                <div>
                    <div>
                        <div className="flex items-center gap-5 mb-20">
                            <h2 className="font-titulos text-[50px] px-5">Hojaldres</h2>
                    ...
                    <div>
                        <div className="flex items-center gap-5 mb-20">
                            <h2 className="font-titulos text-[50px] px-5">Dulces</h2>
                            <div className="w-full h-[2px] bg-gray-500 my-4 "></div>
                        </div>
                        <div className="grid grid-cols-3 gap-6 mb-20">
                    ...
                    <div>
                        <div className="flex items-center gap-5 mb-20">
                            <h2 className="font-titulos text-[50px] px-5">Granos e Integrales</h2>
                            <div className="w-full h-[2px] bg-gray-500 my-4 "></div>
                        </div>
                        <div className="grid grid-cols-3 gap-6 mb-20">
