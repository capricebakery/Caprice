        ...
        <section id="Pedido" className="flex justify-center w-auto mx-auto my-20 px-40">
            <div className="w-auto mx-5 grid grid-cols-2 gap-50">
                ...
                <div className="bg-[#EBEBEB] flex justify-center items-center rounded-full shadow-md shadow-black/35 h-100 w-100">
                    <img className="w-70 h-auto scale-95 hover:scale-120" src="/img/galleta.png" alt="Galleta"/>
                </div>
                {/* info */}
                <div className="flex flex-col justify-center">
                    ...
                    <ul className="font-textos text-[20px] flex flex-col gap-7">
                         ...
                         <li className="flex gap-7 h-auto"><img src="/img/icon-casa.png" alt="Iconon casa"/>Cra 127 D 89 - 23</li>
                         <li className="flex gap-7 h-auto"><img src="/img/icon-reloj.png" alt="Iconon reloj"/>7:00 am - 10:00 pm</li>
                     </ul>
                </div>
            </div>
         </section>
